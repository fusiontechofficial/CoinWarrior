...
import ICoinWarriorPair from '@coin-warrior/core/build/ICoinWarriorPair.json'
...
describe('fee-on-transfer tokens', () => {
  ...
  beforeEach(async function() {
    ...
    pair = new Contract(pairAddress, JSON.stringify(ICoinWarriorPair.abi), provider).connect(wallet)
  })
