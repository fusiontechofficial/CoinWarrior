...
import './interfaces/ICoinWarriorPair.sol';
import './CoinWarriorERC20.sol';
import './libraries/Math.sol';
import './libraries/UQ112x112.sol';
import './interfaces/IERC20.sol';
import './interfaces/ICoinWarriorFactory.sol';
import './interfaces/ICoinWarriorCallee.sol';

contract CoinWarriorPair is ICoinWarriorPair, CoinWarriorERC20 {
    ...
    function _mintFee(uint112 _reserve0, uint112 _reserve1) private returns (bool feeOn) {
        address feeTo = ICoinWarriorFactory(factory).feeTo();
    ...
    function swap(
        ...
        uint256 balance1;
        {
            ...
            if (data.length > 0) ICoinWarriorCallee(to).uniswapV2Call(msg.sender, amount0Out, amount1Out, data);
            balance0 = IERC20(_token0).balanceOf(address(this));
            balance1 = IERC20(_token1).balanceOf(address(this));
        }
